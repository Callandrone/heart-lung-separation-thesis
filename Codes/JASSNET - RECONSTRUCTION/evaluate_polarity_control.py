...
def evaluate_all_folds(
    ...
    for fold_idx in range(args.n_folds):
        ...
        if use_source_disjoint and len(test_names_before_filter) != 16200 :
            print(
                "[WARN] Source-disjoint all-SNR evaluation expected 16200  "
                f"segments for this fold, but found {len(test_names_before_filter)}. "
                "Check base-id formatting, split CSV, or dataset path."
            )
